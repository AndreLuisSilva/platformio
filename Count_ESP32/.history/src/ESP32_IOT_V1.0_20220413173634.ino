...
void send_POST() {
   ...
   //aumentar o tamanho do char conforme necessário para o POST   
    ...
    char data[15];
    char hora[15];
    sprintf(data, "%02c-%02c-%04c", timeinfo.tm_mday, timeinfo.tm_mon + 1, timeinfo.tm_year + 1900);
    sprintf(hora, "%02c:%02c:%02c", timeinfo.tm_hour, timeinfo.tm_min, timeinfo.tm_sec);
    //Serial.print(data);
    //Serial.print(" ");
    //Serial.println(hora);    
