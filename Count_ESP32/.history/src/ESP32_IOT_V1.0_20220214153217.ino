...
void calibra_SCT013()
{
  ...
  //se o estado do botao for nivel lógico alto
  if (ler_Estado_Jumper == LOW)
  {
    ...
    //deixa o led ligado mostrandp que já terminou a calibragem e precisa ser alterado o jumper para o outro lado e reiniciado a placa
    while (true)
    {
      digitalWrite(LED_CALIBRAGEM, HIGH);
    }
